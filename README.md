...
**653 reported occurrences assessed as false positives:** 236 security matches and 417 async-forEach matches. Examples include ordinary array mutations flagged as redirects and synchronous callbacks flagged as asynchronous. Three further async-forEach cases remain unresolved. These are documented source-review assessments—not provider-confirmed dismissals, 653 bugs fixed, or a completed review of the earlier 3,004-entry export. [Triage evidence and repairs →](docs/reviews/xarts-security-runtime-remediation-2026-09-20.md)

**Latest supplied Xarts result:** **64/100 · 3,009 reported issues · Security 7% (239 entries)**, displayed September 20, 2026, 12:24. The earlier result was 63/100 · 3,004 issues · Security 6% (241 entries). This is a small score improvement, **not a broad reduction in findings**: 2,995 export matches persist, nine disappear and fourteen appear, including ten in new audit tooling. Changed snippets are not proven closures. [Rescan comparison and screenshot →](docs/reviews/xarts-rescan-comparison-2026-09-20.md)

The remediation batch is published to Xarts `main` at `ea935d03`: **6,415 tests and 66 SDK tests passed**, with 23 tests skipped. The exports do not identify the scanned commit; test results and reviewer false-positive assessments do not change the provider score by themselves.
