...
function setup(){
 ...
 for(const file of ['server/xarts-delivery.ts','server/xarts-validation.ts','server/container-runner.ts','adapters/xarts/build-worker.mjs','adapters/xarts/consumer-worker.mjs','adapters/xarts/currency-check.mjs','adapters/xarts/counterexample.mjs'])write(file,'// fixture evaluator');
